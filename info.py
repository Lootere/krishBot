...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Movie Star](https://t.me/rkmovieszip)</b>⚡\n\n🎦 <b>File Name: </b> ➥  {file_caption} \n⚙️ <b>Size: </b><i>{file_size}</i>\n")
...
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','rkmovieszip') # WITHOUT @
